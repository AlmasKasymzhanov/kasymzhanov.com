...
/* ───── Verdict Badge ───── */
function Verdict({ type, text }: { type: "no" | "yes" | "maybe"; text: string }) { return <span className="research-decision">{text}</span>; }
      ...
      <div style={{ maxWidth: 920, margin: "0 auto", padding: "40px 24px 80px" }}>
        ...
        <div className="research-header" style={{ marginBottom: 48, paddingBottom: 32, borderBottom: `1px solid ${C.border}` }}>
          ...
          <h1 style={{ fontSize: 32, fontWeight: 500, margin: "0 0 8px", letterSpacing: "-0.03em", lineHeight: 1.2 }}>
            Подбор товаров для входа{" "}на Kaspi.kz
          </h1>
<p className="research-lead">Как выбрать товар для запуска под своим брендом: от отбора ниш и анализа конкурентов до расчёта бюджета.</p>
          <p style={{ color: C.dim, fontSize: 14, margin: "12px 0 0" }}>
            Подготовил <strong style={{ color: C.text }}>Алмас Касымжанов</strong> &middot; на основе данных <strong style={{ color: C.text }}>агрегированные рыночные данные</strong>
          </p>
...
<ResearchReadingTime />
        ...
        <Section id="sec-rejected" title="1. Отклонённые товары — почему НЕТ">
          <p style={sP}>Клиент предложил 5 товаров для входа через OEM (MOQ от 500 шт). Каждый проанализирован по данным агрегированные рыночные данные: выручка, конкуренция, бренды, отзывы.</p>
        ...
        <Section id="sec-recommended" title="2. Рекомендуемые ниши — почему ДА">
          ...
          <div style={{ ...sCard, padding: "20px 24px" }}>
            ...
            <div style={{ fontFamily: "var(--font-mono)", fontSize: 12, lineHeight: 2, color: "var(--personal-text)" }}>
              ...
              <div><span style={{ color: C.green }}>AYOVA чемоданы:</span>{" "} ░░░ ░░░ ░░░ ░░░ <span style={{ color: C.green, fontWeight: 400 }}>▓▓▓ ▓▓▓ ▓▓▓ ▓▓▓</span> ░░░ ░░░ ░░░ ▒▒▒</div>
              <div><span style={{ color: C.accent }}>BRAVAX степперы:</span> <span style={{ color: C.accent, fontWeight: 400 }}>▓▓▓ ▓▓▓</span> ░░░ ░░░ ░░░ ░░░ ░░░ ░░░ ░░░ <span style={{ color: C.accent, fontWeight: 400 }}>▓▓▓ ▓▓▓ ▓▓▓</span></div>
        ...
        <Section id="sec-reviews" title="3. Анализ отзывов — боли покупателей">
          ...
          <div style={{ display: "block", marginBottom: 20 }}>
            <div style={{ ...sCard }}><div style={{ fontSize: 11, color: C.dim }}>Проблема #1</div><div style={{ fontSize: 15, fontWeight: 400, color: C.red }}>Скрип 60%+</div><p style={{ ...sP, fontSize: 12, margin: "4px 0 0" }}>негативных отзывов</p></div>
            <div style={{ ...sCard }}><div style={{ fontSize: 11, color: C.dim }}>Проблема #2</div><div style={{ fontSize: 15, fontWeight: 400, color: C.amber }}>Поломки 2-4 нед</div><p style={{ ...sP, fontSize: 12, margin: "4px 0 0" }}>цилиндры текут</p></div>
            <div style={{ ...sCard }}><div style={{ fontSize: 11, color: C.dim }}>Проблема #3</div><div style={{ fontSize: 15, fontWeight: 400, color: C.pink }}>Ложная нагрузка</div><p style={{ ...sP, fontSize: 12, margin: "4px 0 0" }}>120кг → ломается при 65кг</p></div>
          </div>
          ...
          <div style={{ display: "block", marginBottom: 20 }}>
            <div style={{ ...sCard }}><div style={{ fontSize: 11, color: C.dim }}>Проблема #1</div><div style={{ fontSize: 15, fontWeight: 400, color: C.red }}>Колёса ломаются</div><p style={{ ...sP, fontSize: 12, margin: "4px 0 0" }}>40% негативов</p></div>
            <div style={{ ...sCard }}><div style={{ fontSize: 11, color: C.dim }}>Проблема #2</div><div style={{ fontSize: 15, fontWeight: 400, color: C.amber }}>Замок — брак</div><p style={{ ...sP, fontSize: 12, margin: "4px 0 0" }}>20% негативов</p></div>
            <div style={{ ...sCard }}><div style={{ fontSize: 11, color: C.dim }}>Проблема #3</div><div style={{ fontSize: 15, fontWeight: 400, color: C.pink }}>Запах пластика</div><p style={{ ...sP, fontSize: 12, margin: "4px 0 0" }}>15% негативов</p></div>
          </div>
          ...
          <div style={{ display: "block", marginBottom: 20 }}>
            <div style={{ ...sCard }}><div style={{ fontSize: 11, color: C.dim }}>Проблема #1</div><div style={{ fontSize: 15, fontWeight: 400, color: C.red }}>WiFi отваливается</div><p style={{ ...sP, fontSize: 12, margin: "4px 0 0" }}>30% негативов</p></div>
            <div style={{ ...sCard }}><div style={{ fontSize: 11, color: C.dim }}>Проблема #2</div><div style={{ fontSize: 15, fontWeight: 400, color: C.amber }}>Видео ≠ заявленному</div><p style={{ ...sP, fontSize: 12, margin: "4px 0 0" }}>25% негативов</p></div>
            <div style={{ ...sCard }}><div style={{ fontSize: 11, color: C.dim }}>Проблема #3</div><div style={{ fontSize: 15, fontWeight: 400, color: C.pink }}>Приложение — мусор</div><p style={{ ...sP, fontSize: 12, margin: "4px 0 0" }}>15% негативов</p></div>
          </div>
        ...
        <Section id="sec-mktu" title="5. Товарные знаки и МКТУ">
          <div style={{ display: "block", marginBottom: 24 }}>
            ...
            <div style={sCard}>
              ...
              <p style={{ ...sP, fontSize: 12 }}>Графический знак (красный квадрат). Заявка var(--personal-text)</p>
              <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
        ...
        <Section id="sec-plan" title="7. Финальный план действий">
          ...
          <div style={{ marginTop: 24, padding: "16px 0" }}>
            <p style={{ ...sP, margin: 0, fontSize: 13, color: C.dim }}>
              Данные: <strong style={{ color: C.text }}>агрегированные рыночные данные</strong> (агрегированный массив данных, 73 000+ ниш, нояб 2024 - фев 2026) + <strong style={{ color: C.text }}>ShopHunter</strong> (Amazon трекинг).
