    ...
    <div style={{ minHeight: "100vh", background: C.bg, color: C.text, fontFamily: "var(--font-body)" }}>
      <div style={{ maxWidth: 960, margin: "0 auto", padding: "40px 24px 80px" }}>
        ...
        <div className="research-header" style={{ marginBottom: 48, paddingBottom: 32, borderBottom: `1px solid ${C.border}` }}>
          <div style={sBadge(C.accent)}><span style={{ textTransform: "none", letterSpacing: "0.05em" }}>Strategic Recommendations</span></div>
          <h1 style={{ fontSize: 32, fontWeight: 500, margin: "16px 0 8px", letterSpacing: "-0.03em", lineHeight: 1.2 }}>
            Стратегические рекомендации{" "}по Beauty-портфелю
          </h1>
<p className="research-lead">Разбор портфеля косметических брендов на Kaspi и Wildberries: приоритеты, ассортимент и следующие шаги.</p>
          ...
          <p className="research-lead" style={{ ...sP, marginTop: 16, fontSize: 13, color: C.dim }}>Финальный стратегический документ на основе трёх предыдущих отчётов: рынок Kaspi, портфель 21 бренда, рынок WB. Содержит приоритизацию, план по кварталам, ценовую политику, канальную стратегию и конкретные действия.</p>
...
<ResearchReadingTime />
        ...
        {/* ═══ 1. EXEC SUMMARY ═══ */}
        <Section id="s1" title="1. Обзор — ключевые решения">
        ...
        <Section id="s7" title="7. Топ-5 быстрых побед (ближайшие 30 дней)">
          <div style={sCard}>
            <div style={{ fontSize: 13, lineHeight: 2.5, color: "var(--personal-text)" }}>
              {[
                ...
                <div key={item.n} style={{ ...sCard, margin: "0 0 12px" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }}>
                    <span style={{ fontSize: 15, fontWeight: 400, color: C.text }}>{item.n}. {item.t}</span>
          ...
          <div style={sCard}>
            <div style={{ fontSize: 13, lineHeight: 2.5, color: "var(--personal-text)" }}>
              {[
                ...
                <div key={item.n} style={{ ...sCard, margin: "0 0 12px" }}>
                  <div style={{ fontSize: 15, fontWeight: 400, color: C.text, marginBottom: 8 }}>{item.n}. {item.t}</div>
                  <p style={{ ...sP, margin: 0, fontSize: 13 }}>{item.d}</p>
                </div>
              ))}
            </div>
        ...
        <Section id="s10" title="10. KPI и метрики успеха">
          <DataTable headers={["KPI", "Текущее", "Цель 6 мес", "Цель 12 мес", "Как измерять"]} rows={[
            ["Суммарная выручка Kaspi", "~900M KZT/мес", "1.4B", "2B", "агрегированные рыночные данные помесячно"],
            ["Суммарная выручка WB", "~975M KZT/мес", "1.5B", "2.5B", "агрегированные данные Wildberries помесячно"],
            ["Количество брендов >50M на Kaspi", "6", "8", "10", "агрегированные рыночные данные бренд-сплит"],
            ["COSRX выручка на Kaspi", "16M", "30M", "50M", "агрегированные рыночные данные"],
            ["Treecell выручка (шампуни)", "<1M", "5M", "15M", "агрегированные рыночные данные"],
            ["Средний рейтинг портфеля", "4.8", "4.85", "4.9", "Kaspi/WB"],
            ["% негативных отзывов о подделках", "~30%", "<15%", "<5%", "Анализ отзывов"],
            ["Доля наборов в выручке", "~15%", "25%", "30%", "агрегированные рыночные данные, пики 8 мар/НГ"],
          ]} />
        ...
        {/* ═══ FOOTER ═══ */}
        <div style={{ marginTop: 40, padding: "16px 0" }}>
          ...
          <p style={{ ...sP, margin: "0 0 8px", fontSize: 13, color: C.dim }}>
            Источники данных: агрегированные данные Kaspi.kz &middot; агрегированные данные Wildberries
          </p>
