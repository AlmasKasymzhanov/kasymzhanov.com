    ...
    <div style={{ minHeight: "100vh", background: C.bg, color: C.text, fontFamily: "var(--font-body)" }}>
      <div style={{ maxWidth: 960, margin: "0 auto", padding: "40px 24px 80px" }}>
        ...
        <div className="research-header" style={{ marginBottom: 48, paddingBottom: 32, borderBottom: `1px solid ${C.border}` }}>
          <div style={sBadge(C.accent)}><span style={{ textTransform: "none", letterSpacing: "0.05em" }}>Q&A — Ответы на вопросы</span></div>
          <h1 style={{ fontSize: 32, fontWeight: 500, margin: "16px 0 8px", letterSpacing: "-0.03em", lineHeight: 1.2 }}>
            Ответы на вопросы{" "}по аналитике рынка
          </h1>
          <p style={{ color: C.dim, fontSize: 14, margin: "12px 0 0" }}>
            Подготовил <strong style={{ color: C.text }}>Алмас Касымжанов</strong>
          </p>
          <p className="research-lead" style={{ ...sP, marginTop: 12, fontSize: 13, color: C.dim }}>Детальные ответы с верифицированными данными на каждый вопрос. Все цифры перепроверены напрямую через аналитическую систему на момент подготовки ответов (апрель 2026).</p>
...
<ResearchReadingTime />
        ...
        <div style={{ marginBottom: 56 }}>
          <div style={{ ...sCard }}>
            ...
            <h2 style={{ fontSize: 15, fontWeight: 400, color: C.text, margin: 0, lineHeight: 1.7 }}>
          ...
          <div style={{ ...sCard }}>
            ...
            <div style={{ ...sCard, padding: "16px 0", marginBottom: 16 }}>
              <div style={{ fontSize: 12, color: C.blue, fontWeight: 400, marginBottom: 4 }}>Период данных</div>
              <div style={{ fontSize: 13, color: "var(--personal-text)" }}>Все цифры ниже — за <strong style={{ color: C.text }}>февраль 2026</strong> (последний полный месяц в аналитической системе). Источник: агрегированные данные Kaspi.kz. Данные верифицированы повторно в апреле 2026.</div>
            </div>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "24px 0 16px" }}>1. Кремы и сыворотки — крупнейшая ниша (1 712M KZT в феврале 2026)</h3>
            ...
            <div style={{ ...sCard, padding: "16px 0" }}>
              <div style={{ fontSize: 13, fontWeight: 400, color: C.text, marginBottom: 8 }}>Бестселлер ниши: Dr. Althea 345 Relief Cream 50мл</div>
              <div style={{ fontSize: 12, color: "var(--personal-text)", lineHeight: 1.8 }}>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>2. Средства для умывания — #2 ниша (517M KZT в феврале 2026)</h3>
            ...
            <div style={{ ...sCard, padding: "16px 0" }}>
              <div style={{ fontSize: 13, fontWeight: 400, color: C.text, marginBottom: 8 }}>Бестселлер ниши: Round Lab 1025 Dokdo Cleanser 150мл (пенка)</div>
              <div style={{ fontSize: 12, color: "var(--personal-text)", lineHeight: 1.8 }}>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>3. Тоники и тонеры — #3 ниша (290M KZT в феврале 2026)</h3>
            ...
            <div style={{ ...sCard, padding: "16px 0" }}>
              <div style={{ fontSize: 13, fontWeight: 400, color: C.text, marginBottom: 8 }}>Бестселлер ниши: Celimax Dual Barrier Toner 150мл</div>
              <div style={{ fontSize: 12, color: "var(--personal-text)", lineHeight: 1.8 }}>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>4. Маски для лица — #4 ниша (122M KZT в феврале 2026)</h3>
            <DataTable headers={["#", "Бренд", "Выручка (фев 2026)", "Заказов (фев 2026)"]} rows={[
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>5. Скрабы и пилинги — #5 ниша (64M KZT в феврале 2026)</h3>
            <DataTable headers={["#", "Бренд", "Выручка (фев 2026)", "Заказов (фев 2026)"]} rows={[
              ["1", "Celimax", "13M", "2 698"],
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>6. Патчи — самая быстрорастущая ниша (45M KZT в феврале 2026, +114% YoY)</h3>
            <DataTable headers={["#", "Бренд", "Выручка (фев 2026)", "Заказов (фев 2026)"]} rows={[
              ["1", "SADOER", "6M", "7 306"],
              ["2", "MeyRim", "4M", "3 216"],
              ["3", "COSRX", "4M", "2 337"],
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.green, margin: "32px 0 16px", borderTop: `1px solid ${C.border}`, paddingTop: 24 }}>Итого: что конкретно в лидерах</h3>
            ...
            <div style={{ paddingLeft: 14, margin: "16px 0", fontSize: 14, color: "var(--personal-text)", lineHeight: 1.6 }}>
        ...
        <div style={{ marginBottom: 56 }}>
          ...
          <div style={{ ...sCard }}>
            ...
            <div style={{ ...sCard, padding: "16px 0", marginBottom: 16 }}>
              <div style={{ fontSize: 12, color: C.blue, fontWeight: 400, marginBottom: 4 }}>Период данных</div>
              <div style={{ fontSize: 13, color: "var(--personal-text)" }}>Выручка и заказы — за <strong style={{ color: C.text }}>февраль 2026</strong>. YoY рост — сравнение суммы за <strong style={{ color: C.text }}>ноябрь 2024 — февраль 2025</strong> vs <strong style={{ color: C.text }}>ноябрь 2025 — февраль 2026</strong> (4 пересекающихся месяца). Источник: агрегированные данные Kaspi.kz.</div>
            </div>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "24px 0 16px" }}>Полная картина: 9 ниш декоративной косметики</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.pink, margin: "28px 0 16px" }}>Что растёт быстрее всего</h3>

            <div style={{ ...sCard, padding: "16px 0" }}>
              <div style={{ fontSize: 14, fontWeight: 400, color: C.green, marginBottom: 8 }}>1. Корректоры и консилеры — +114% YoY (самый быстрый рост!)</div>
            ...
            <div style={{ ...sCard, padding: "16px 0" }}>
              <div style={{ fontSize: 14, fontWeight: 400, color: C.green, marginBottom: 8 }}>2. Румяна и бронзеры — +66% YoY</div>
              <div style={{ fontSize: 13, color: "var(--personal-text)", lineHeight: 1.8 }}>
            ...
            <div style={{ ...sCard, padding: "16px 0" }}>
              <div style={{ fontSize: 14, fontWeight: 400, color: C.green, marginBottom: 8 }}>3. Контур для глаз — +66% YoY</div>
              <div style={{ fontSize: 13, color: "var(--personal-text)", lineHeight: 1.8 }}>
            ...
            <div style={{ ...sCard, padding: "16px 0" }}>
              <div style={{ fontSize: 14, fontWeight: 400, color: C.blue, marginBottom: 8 }}>4. Пудры — +51% YoY</div>
              <div style={{ fontSize: 13, color: "var(--personal-text)", lineHeight: 1.8 }}>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>Крупнейшие ниши по объёму</h3>

            <div style={{ ...sCard, padding: "16px 0" }}>
              <div style={{ fontSize: 14, fontWeight: 400, color: C.pink, marginBottom: 8 }}>Тональные средства — крупнейшая ниша декора (536M), но рост замедлился (+5%)</div>
              <div style={{ fontSize: 13, color: "var(--personal-text)", lineHeight: 1.8 }}>
            ...
            <div style={{ ...sCard, padding: "16px 0" }}>
              <div style={{ fontSize: 14, fontWeight: 400, color: C.pink, marginBottom: 8 }}>Помады и блески — #2 по объёму (209M), рост +26%</div>
              <div style={{ fontSize: 13, color: "var(--personal-text)", lineHeight: 1.8 }}>
            ...
            <div style={{ ...sCard, padding: "16px 0" }}>
              <div style={{ fontSize: 14, fontWeight: 400, color: C.pink, marginBottom: 8 }}>Тушь — 149M, рост умеренный (+7%)</div>
              <div style={{ fontSize: 13, color: "var(--personal-text)", lineHeight: 1.8 }}>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.green, margin: "32px 0 16px", borderTop: `1px solid ${C.border}`, paddingTop: 24 }}>Итого: кто доминирует в декоративке</h3>
        ...
        <div style={{ marginBottom: 56 }}>
          ...
          <div style={{ ...sCard }}>
            ...
            <div style={{ ...sCard, padding: "16px 0", marginBottom: 16 }}>
              <div style={{ fontSize: 12, color: C.blue, fontWeight: 400, marginBottom: 4 }}>Период данных</div>
              <div style={{ fontSize: 13, color: "var(--personal-text)" }}>Все цены и выручка — за <strong style={{ color: C.text }}>февраль 2026</strong>. Цены = розничная цена на Kaspi.kz на момент среза данных. Источник: агрегированные данные Kaspi.kz, верифицировано повторно в апреле 2026.</div>
            </div>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "24px 0 16px" }}>УХОДОВАЯ КОСМЕТИКА — лидеры с ценами</h3>

            <h3 style={{ fontSize: 15, fontWeight: 400, color: C.text, margin: "20px 0 12px" }}>Dr. Althea — #1 в кремах и сыворотках (142M в феврале 2026)</h3>
            ...
            <div style={{ paddingLeft: 14, margin: "8px 0", fontSize: 13, color: "var(--personal-text)", lineHeight: 1.6 }}>
            ...
            <h3 style={{ fontSize: 15, fontWeight: 400, color: C.text, margin: "24px 0 12px" }}>Celimax — #1 в тониках (61M), #3 в кремах (89M)</h3>
            ...
            <h3 style={{ fontSize: 15, fontWeight: 400, color: C.text, margin: "24px 0 12px" }}>Round Lab — #2 в умывании (36M)</h3>
            <DataTable headers={["Товар", "Формат", "Розница", "Выручка (фев 2026)", "Продажи"]} rows={[
            ...
            <h3 style={{ fontSize: 15, fontWeight: 400, color: C.text, margin: "24px 0 12px" }}>AXIS-Y — #2 в масках, #4 в тониках</h3>
            <DataTable headers={["Товар", "Формат", "Розница", "Выручка (фев 2026)", "Продажи"]} rows={[
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "32px 0 16px", borderTop: `1px solid ${C.border}`, paddingTop: 24 }}>ДЕКОРАТИВНАЯ КОСМЕТИКА — лидеры с ценами</h3>

            <h3 style={{ fontSize: 15, fontWeight: 400, color: C.text, margin: "20px 0 12px" }}>RoRoBell — #1 в тональных (72M в феврале 2026)</h3>
            <DataTable headers={["Товар", "Формат", "Розница", "Выручка (фев 2026)", "Продажи", "Отзывы"]} rows={[
            ...
            <h3 style={{ fontSize: 15, fontWeight: 400, color: C.text, margin: "24px 0 12px" }}>Sen Sulu — #1 в помадах, пудрах, тенях, корректорах</h3>
            ...
            <h3 style={{ fontSize: 15, fontWeight: 400, color: C.text, margin: "24px 0 12px" }}>HOURGLASS — #1 в румянах (30M в феврале 2026)</h3>
            <DataTable headers={["Товар", "Формат", "Розница", "Выручка (фев 2026)", "Продажи", "Отзывы"]} rows={[
            ...
            <h3 style={{ fontSize: 15, fontWeight: 400, color: C.text, margin: "24px 0 12px" }}>Loreal Paris — #1 в туши (23M в феврале 2026)</h3>
            <DataTable headers={["Товар", "Формат", "Розница", "Выручка (фев 2026)", "Продажи", "Отзывы"]} rows={[
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.green, margin: "32px 0 16px", borderTop: `1px solid ${C.border}`, paddingTop: 24 }}>Сводка: ценовые диапазоны лидеров</h3>
        ...
        <div style={{ marginBottom: 56 }}>
          ...
          <div style={{ ...sCard }}>
            ...
            <div style={{ ...sCard, padding: "16px 0", marginBottom: 16 }}>
              <div style={{ fontSize: 12, color: C.blue, fontWeight: 400, marginBottom: 4 }}>Период данных</div>
              <div style={{ fontSize: 13, color: "var(--personal-text)" }}>Выручка и продажи — за <strong style={{ color: C.text }}>февраль 2026</strong>. История ниши — помесячно за <strong style={{ color: C.text }}>ноябрь 2024 — февраль 2026</strong> (16 точек). Отзывы — все накопленные на момент среза. Источник: агрегированные данные Kaspi.kz.</div>
            </div>

            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "20px 0 16px" }}>Ниша «Патчи» — полный разбор</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "24px 0 16px" }}>Кто лидер? Все бренды патчей (февраль 2026)</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>SADOER — какие именно патчи и за сколько?</h3>
            ...
            <h3 style={{ fontSize: 15, fontWeight: 400, color: C.text, margin: "24px 0 12px" }}>Чем взял SADOER? Почему китайский бренд — #1?</h3>

            <div style={{ fontSize: 13, lineHeight: 2, color: "var(--personal-text)", marginBottom: 16 }}>
            ...
            <h3 style={{ fontSize: 15, fontWeight: 400, color: C.text, margin: "24px 0 12px" }}>Что говорят покупатели? (отзывы SADOER патчи)</h3>
            <p style={{ ...sP, fontSize: 12, color: C.dim }}>SADOER Aloe Vera Collagen: 560 отзывов, 549 позитивных, 11 негативных (2%)</p>

            <div style={{ paddingLeft: 14, margin: "8px 0", fontSize: 13, color: "var(--personal-muted)" }}><span style={sBadge(C.green)}>5/5</span> «Отличное качество. Заметный эффект сразу. Спасибо за быструю доставку.»</div>
            <div style={{ paddingLeft: 14, margin: "8px 0", fontSize: 13, color: "var(--personal-muted)" }}><span style={sBadge(C.green)}>5/5</span> «Первый раз такие попались, результат виден сразу!»</div>
            <div style={{ paddingLeft: 14, margin: "8px 0", fontSize: 13, color: "var(--personal-muted)" }}><span style={sBadge(C.green)}>5/5</span> «Второй раз заказываю. Мне очень понравилось.»</div>
            <div style={{ paddingLeft: 14, margin: "8px 0", fontSize: 13, color: "var(--personal-muted)" }}><span style={sBadge(C.red)}>1/5</span> «Сползают страшно. Быстро высыхают. Жёсткие на ощупь.»</div>
            <div style={{ paddingLeft: 14, margin: "8px 0", fontSize: 13, color: "var(--personal-muted)" }}><span style={sBadge(C.red)}>1/5</span> «Мешки не ушли, наоборот выделились. Пустая трата денег.»</div>

            <h3 style={{ fontSize: 15, fontWeight: 400, color: C.text, margin: "24px 0 12px" }}>А что с конкурентами? Топ-10 конкретных SKU патчей на Kaspi</h3>
            ...
            <div style={{ paddingLeft: 14, margin: "20px 0", fontSize: 14, color: "var(--personal-text)", lineHeight: 1.6 }}>
              <strong style={{ color: C.green }}>Короткий ответ: </strong>
        ...
        <div style={{ marginBottom: 56 }}>
          ...
          <div style={{ ...sCard }}>
            ...
            <div style={{ ...sCard, padding: "16px 0", marginBottom: 16 }}>
              <div style={{ fontSize: 12, color: C.blue, fontWeight: 400, marginBottom: 4 }}>Период данных</div>
              <div style={{ fontSize: 13, color: "var(--personal-text)" }}>Все цифры — за <strong style={{ color: C.text }}>февраль 2026</strong>. История — помесячно с <strong style={{ color: C.text }}>ноября 2024</strong>. Источник: агрегированные данные Kaspi.kz. Данные = <strong style={{ color: C.text }}>только онлайн (Kaspi.kz)</strong>, офлайн-продажи не учитываются.</div>
            </div>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "24px 0 16px" }}>Полный рейтинг шампуней на Kaspi (февраль 2026)</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>Разбор каждого из трёх брендов</h3>

            <div style={{ ...sCard }}>
              <h3 style={{ fontSize: 15, fontWeight: 400, color: C.pink, margin: "0 0 12px" }}>elline — #1 в онлайне (103M в феврале 2026)</h3>
              ...
              <div style={{ fontSize: 13, lineHeight: 1.8, color: "var(--personal-text)", marginBottom: 12 }}>
            ...
            <div style={{ ...sCard }}>
              <h3 style={{ fontSize: 15, fontWeight: 400, color: C.blue, margin: "0 0 12px" }}>Ederra Lab — #10 в онлайне (11M в феврале 2026)</h3>
              <DataTable headers={["Товар", "Формат", "Розница", "Выручка (фев 2026)", "Продажи", "Отзывы"]} rows={[
                ["Б600 01 Бессульфатный шампунь", "600 мл", "19 500 ₸", "2M", "110 шт", "416"],
              ]} />
              <div style={{ fontSize: 13, lineHeight: 1.8, color: "var(--personal-text)" }}>
            ...
            <div style={{ ...sCard }}>
              <h3 style={{ fontSize: 15, fontWeight: 400, color: C.cyan, margin: "0 0 12px" }}>Embrace — за пределами топ-10 (~10M в феврале 2026)</h3>
              <DataTable headers={["Товар", "Формат", "Розница", "Выручка (фев 2026)", "Продажи", "Отзывы", "Рейтинг"]} rows={[
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>Сравнение трёх брендов</h3>
        ...
        <div style={{ marginBottom: 56 }}>
          ...
          <div style={{ ...sCard }}>
            ...
            <div style={{ ...sCard, padding: "16px 0", marginBottom: 16 }}>
              <div style={{ fontSize: 12, color: C.blue, fontWeight: 400, marginBottom: 4 }}>Период данных</div>
              <div style={{ fontSize: 13, color: "var(--personal-text)" }}>Ценовые сегменты — за <strong style={{ color: C.text }}>февраль 2026</strong>. Позиции Ekel и Farmstay — текущие (февраль 2026). Источник: агрегированные данные Kaspi.kz.</div>
            </div>

            <p style={sP}>Ваше наблюдение <strong style={{ color: C.green }}>полностью подтверждается данными</strong>. Вот конкретные цифры.</p>

            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "24px 0 16px" }}>Ценовые сегменты кремов и сывороток (февраль 2026)</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>Ekel и Farmstay — подтверждение упадка масс-маркета</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>Средний сегмент: кто именно растёт</h3>
        ...
        <div style={{ marginBottom: 56 }}>
          ...
          <div style={{ ...sCard }}>
            ...
            <div style={{ ...sCard, padding: "16px 0", marginBottom: 16 }}>
              <div style={{ fontSize: 12, color: C.blue, fontWeight: 400, marginBottom: 4 }}>Период данных</div>
              <div style={{ fontSize: 13, color: "var(--personal-text)" }}>Выручка, продажи, цены — за <strong style={{ color: C.text }}>февраль 2026</strong>. Ценовые сегменты — за <strong style={{ color: C.text }}>февраль 2026</strong>. Источник: агрегированные данные Kaspi.kz.</div>
            </div>

            <p style={sP}>Разберём подробно, что составляет эти 43% (371M KZT) в премиум-сегменте наборов.</p>

            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "24px 0 16px" }}>Ценовые сегменты наборов (февраль 2026)</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>Топ-20 конкретных наборов на Kaspi по выручке</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.pink, margin: "28px 0 16px" }}>Кто формирует премиум-сегмент наборов (43%)?</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.amber, margin: "28px 0 16px" }}>А где люкс-бренды? Charlotte Tilbury, Dior, CHANEL?</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>Итого: структура премиум-наборов на Kaspi</h3>
        ...
        <div style={{ marginBottom: 56 }}>
          ...
          <div style={{ ...sCard }}>
            ...
            <div style={{ ...sCard, padding: "16px 0", marginBottom: 16 }}>
              <div style={{ fontSize: 12, color: C.blue, fontWeight: 400, marginBottom: 4 }}>Период данных</div>
              <div style={{ fontSize: 13, color: "var(--personal-text)" }}>Таблица из скриншота — за <strong style={{ color: C.text }}>1 месяц (февраль 2026)</strong>. 142M = выручка Dr. Althea за один месяц в категории «Кремы и сыворотки» на Kaspi.kz. <strong style={{ color: C.text }}>Только онлайн-продажи Kaspi</strong>, без офлайна. Источник: агрегированные данные Kaspi.kz. Мы обновили отчёт — период теперь указан явно в заголовках таблиц.</div>
            </div>

            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "20px 0 16px" }}>1. Dr. Althea 142M — разбивка по позициям</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>2. AXIS-Y vs Round Lab — детальное сравнение на Kaspi</h3>

            <h3 style={{ fontSize: 15, fontWeight: 400, color: C.text, margin: "20px 0 12px" }}>AXIS-Y — 8 уникальных SKU на Kaspi (февраль 2026)</h3>
            ...
            <h3 style={{ fontSize: 15, fontWeight: 400, color: C.text, margin: "24px 0 12px" }}>Round Lab — 8+ уникальных SKU на Kaspi (февраль 2026)</h3>
            <DataTable headers={["#", "Позиция", "Розница", "Выручка (фев 2026)", "Продажи", "Категория"]} rows={[
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>Сравнительная таблица</h3>
            ...
            <div style={{ ...sCard, padding: "16px 0", marginTop: 16 }}>
              <div style={{ fontSize: 13, fontWeight: 400, color: C.amber, marginBottom: 8 }}>Важное уточнение по периоду</div>
              <div style={{ fontSize: 13, color: "var(--personal-text)", lineHeight: 1.8 }}>
              ...
              <div style={{ fontSize: 13, color: "var(--personal-text)", marginTop: 8 }}>
                Обновлённый отчёт: <a href="/reports/kaspi-cosmetics" style={{ color: C.accent, textDecoration: "none", fontWeight: 500 }}>Рынок «Красота и здоровье» на Kaspi.kz <IconlyArrowRight size={17} className="reading-inline-icon" /></a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div style={{ marginBottom: 56 }}>
          ...
          <div style={{ ...sCard }}>
            ...
            <div style={{ ...sCard, padding: "16px 0", marginBottom: 16 }}>
              <div style={{ fontSize: 12, color: C.blue, fontWeight: 400, marginBottom: 4 }}>Период данных</div>
              <div style={{ fontSize: 13, color: "var(--personal-text)" }}>Все цифры — за <strong style={{ color: C.text }}>февраль 2026</strong>, только <strong style={{ color: C.text }}>Kaspi.kz онлайн</strong>. Источник: агрегированные данные Kaspi.kz.</div>
            </div>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "24px 0 16px" }}>DR.PLINUS — общие показатели на Kaspi (февраль 2026)</h3>

            <div style={{ display: "flex", gap: 12, flexWrap: "wrap", marginBottom: 16 }}>
              <div style={{ ...sCard, padding: "14px 18px", flex: 1, minWidth: 130 }}><div style={{ fontSize: 11, color: C.dim }}>Суммарная выручка</div><div style={{ fontSize: 16, fontWeight: 400, color: C.green }}>55M KZT</div><div style={{ fontSize: 11, color: C.dim }}>в феврале 2026</div></div>
              <div style={{ ...sCard, padding: "14px 18px", flex: 1, minWidth: 130 }}><div style={{ fontSize: 11, color: C.dim }}>Продажи</div><div style={{ fontSize: 16, fontWeight: 400 }}>4 614 шт</div><div style={{ fontSize: 11, color: C.dim }}>в феврале 2026</div></div>
              <div style={{ ...sCard, padding: "14px 18px", flex: 1, minWidth: 130 }}><div style={{ fontSize: 11, color: C.dim }}>Уникальных SKU</div><div style={{ fontSize: 16, fontWeight: 400 }}>9</div><div style={{ fontSize: 11, color: C.dim }}>позиций</div></div>
              <div style={{ ...sCard, padding: "14px 18px", flex: 1, minWidth: 130 }}><div style={{ fontSize: 11, color: C.dim }}>Средний рейтинг</div><div style={{ fontSize: 16, fontWeight: 400, color: C.green }}>4.9</div><div style={{ fontSize: 11, color: C.dim }}>все позиции</div></div>
            </div>

            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "24px 0 16px" }}>Все 9 позиций DR.PLINUS — от лидера к наименьшему</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>Структура продаж DR.PLINUS</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>Где DR.PLINUS в общем рейтинге?</h3>
        ...
        <div style={{ marginBottom: 56 }}>
          ...
          <div style={{ ...sCard }}>
            ...
            <div style={{ ...sCard, padding: "16px 0", marginBottom: 16 }}>
              <div style={{ fontSize: 12, color: C.blue, fontWeight: 400, marginBottom: 4 }}>Период данных</div>
              <div style={{ fontSize: 13, color: "var(--personal-text)" }}>Таблица = <strong style={{ color: C.text }}>один месяц (февраль 2026)</strong>, только <strong style={{ color: C.text }}>Kaspi.kz онлайн</strong>. Основной отчёт также обновлён — заголовки таблиц теперь содержат «(фев 2026)».</div>
            </div>

            <p style={sP}>Разбираем каждый бренд из топ-10 умывания — с конкретными позициями.</p>

            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "24px 0 16px" }}>Каждый бренд из топ-10 — с какой именно позицией</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>Round Lab — разбивка по пенкам</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>Bioderma — не мицеллярка, а гель</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>Sugarlife (#10, 12M) — почему в топ-10?</h3>
        ...
        <div style={{ marginBottom: 56 }}>
          ...
          <div style={{ ...sCard }}>
            ...
            <div style={{ ...sCard, padding: "16px 0", marginBottom: 16 }}>
              <div style={{ fontSize: 12, color: C.blue, fontWeight: 400, marginBottom: 4 }}>Период данных</div>
              <div style={{ fontSize: 13, color: "var(--personal-text)" }}>Все таблицы = <strong style={{ color: C.text }}>один месяц — февраль 2026</strong>. Не март, не год — именно <strong style={{ color: C.text }}>февраль 2026</strong> (последний полный месяц на момент подготовки отчёта). Только Kaspi.kz онлайн. Основной отчёт обновлён — период теперь указан в заголовках: <a href="/reports/kaspi-cosmetics" style={{ color: C.accent, textDecoration: "none" }}>открыть обновлённый отчёт <IconlyArrowRight size={17} className="reading-inline-icon" /></a></div>
            </div>

            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "20px 0 16px" }}>Тоники — каждый бренд с конкретной позицией</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>Кремы — каждый бренд с конкретной позицией</h3>
        ...
        <div style={{ marginBottom: 56 }}>
          ...
          <div style={{ ...sCard }}>
            ...
            <div style={{ ...sCard, padding: "16px 0", marginBottom: 16 }}>
              <div style={{ fontSize: 12, color: C.blue, fontWeight: 400, marginBottom: 4 }}>Период данных</div>
              <div style={{ fontSize: 13, color: "var(--personal-text)" }}>Помесячная динамика: <strong style={{ color: C.text }}>ноябрь 2024 — февраль 2026</strong> (16 точек). SKU-данные: <strong style={{ color: C.text }}>февраль 2026</strong>. Только Kaspi.kz онлайн. Источник: агрегированные данные Kaspi.kz.</div>
            </div>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "24px 0 16px" }}>Помесячная динамика MEDI-PEEL в кремах</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>Какие именно позиции «выстрелили»</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>Структура: что именно дало рост</h3>
        ...
        <div style={{ marginBottom: 56 }}>
          ...
          <div style={{ ...sCard }}>
            ...
            <div style={{ ...sCard, padding: "16px 0", marginBottom: 16 }}>
              <div style={{ fontSize: 12, color: C.blue, fontWeight: 400, marginBottom: 4 }}>Период данных</div>
              <div style={{ fontSize: 13, color: "var(--personal-text)" }}>Все цифры ниже = <strong style={{ color: C.text }}>один месяц — февраль 2026</strong>. Только <strong style={{ color: C.text }}>Kaspi.kz онлайн</strong>. Источник: агрегированные данные Kaspi.kz.</div>
            </div>

            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "20px 0 16px" }}>Sen Sulu / The Yeon — BB-кремы на Kaspi</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>RoRoBell — тональный vs кушон</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>MISSHA BB — позиция среди тональных</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>MIZON BB — позиция</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.green, margin: "32px 0 16px", borderTop: `1px solid ${C.border}`, paddingTop: 24 }}>Сравнительная таблица: все три бренда</h3>
        ...
        <div style={{ marginBottom: 56 }}>
          ...
          <div style={{ ...sCard }}>
            ...
            <div style={{ ...sCard, padding: "16px 0", marginBottom: 16 }}>
              <div style={{ fontSize: 12, color: C.blue, fontWeight: 400, marginBottom: 4 }}>Период данных</div>
              <div style={{ fontSize: 13, color: "var(--personal-text)" }}>Все цифры = <strong style={{ color: C.text }}>февраль 2026</strong>, только Kaspi.kz онлайн.</div>
            </div>

            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "20px 0 16px" }}>#1 бренд в каждой из 9 ниш декоративки</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>PRE MORE и RoRoBell в тональных</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>Sen Sulu / The Yeon BB в тональных</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>BB MISSHA и BB MIZON — позиции в тональных</h3>
        ...
        <div style={{ marginBottom: 56 }}>
          ...
          <div style={{ ...sCard }}>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "20px 0 16px" }}>Embrace в рейтинге шампуней на Kaspi (февраль 2026)</h3>
        ...
        <div style={{ marginBottom: 56 }}>
          ...
          <div style={{ ...sCard }}>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "20px 0 16px" }}>Дезодоранты (196M) — корейских брендов нет в топ-15</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>Средства для душа (159M) — корейских в топ-10 тоже нет</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>Скрабы для тела (36M) — The Act лидирует</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>Ценовой вопрос: дешёвый или дорогой сегмент?</h3>
        ...
        <div style={{ marginBottom: 56 }}>
          ...
          <div style={{ ...sCard }}>
            ...
            <div style={{ ...sCard, padding: "16px 0", marginBottom: 16 }}>
              <div style={{ fontSize: 12, color: C.blue, fontWeight: 400, marginBottom: 4 }}>Период данных</div>
              <div style={{ fontSize: 13, color: "var(--personal-text)" }}>Выручка = <strong style={{ color: C.text }}>февраль 2026</strong>. История = помесячно <strong style={{ color: C.text }}>ноябрь 2024 — февраль 2026</strong>. Только Kaspi.kz онлайн.</div>
            </div>

            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "20px 0 16px" }}>Помесячная динамика: как росли кремы для тела</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>Кто лидирует? Топ-10 брендов (февраль 2026)</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>Топ-SKU: что конкретно продаётся</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>Ценовые сегменты кремов для тела</h3>
        ...
        <div style={{ marginBottom: 56 }}>
          ...
          <div style={{ ...sCard }}>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "20px 0 16px" }}>Gegemoon (#1 в масках, 13M) — что именно за маска</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>La Roche-Posay (#1 в кремах для тела, 26M) — конкретный продукт</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>Наборы «Без бренда» (106M) — что это?</h3>
        ...
        <div style={{ marginBottom: 56 }}>
          ...
          <div style={{ ...sCard }}>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "20px 0 16px" }}>Что входит в «Скрабы и пилинги» на Kaspi (64M)</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>А где энзимные пудры?</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>Итого: структура «очищения» на Kaspi</h3>
        ...
        <div style={{ marginBottom: 56 }}>
          ...
          <div style={{ ...sCard }}>
            ...
            <div style={{ ...sCard, padding: "16px 0", marginBottom: 16 }}>
              <div style={{ fontSize: 12, color: C.blue, fontWeight: 400, marginBottom: 4 }}>Период данных</div>
              <div style={{ fontSize: 13, color: "var(--personal-text)" }}>Все цифры = <strong style={{ color: C.text }}>февраль 2026</strong> и помесячно <strong style={{ color: C.text }}>ноябрь 2024 — февраль 2026</strong>.</div>
            </div>

            <p style={sP}>Ваше замечание логически обоснованно. Давайте разберём по фактам.</p>

            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "20px 0 16px" }}>Суть: это РАЗНЫЕ категории</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>История: кто был #1 в кремах раньше?</h3>
            ...
            <div style={{ ...sCard, padding: "16px 0", marginTop: 16 }}>
              <div style={{ fontSize: 13, fontWeight: 400, color: C.amber, marginBottom: 8 }}>Уточнение формулировки</div>
              <div style={{ fontSize: 13, color: "var(--personal-text)", lineHeight: 1.6 }}>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>Ваш вопрос про Round Lab и умывание</h3>
        ...
        <div style={{ marginBottom: 56 }}>
          <div style={{ ...sCard }}>
            ...
            <h2 style={{ fontSize: 15, fontWeight: 400, color: C.text, margin: 0, lineHeight: 1.7 }}>
              «Как самостоятельно перепроверять бренды и товары? Иногда я ввожу название, но ничего не нахожу. Покажите понятный порядок проверки.»
            </h2>
          </div>
          ...
          <div style={{ ...sCard }}>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "20px 0 16px" }}>Частая проблема: «ничего не показывает»</h3>

            <div style={{ ...sCard, padding: "16px 0" }}>
              <div style={{ fontSize: 13, fontWeight: 400, color: C.red, marginBottom: 8 }}>Причина #1: Регистр поиска</div>
              <div style={{ fontSize: 13, color: "var(--personal-text)", lineHeight: 1.8 }}>
                <div>В каталоге Kaspi один и тот же бренд может быть записан в нескольких вариантах. Если поиск по <strong style={{ color: C.red }}>«celimax»</strong> ничего не дал, проверьте <strong style={{ color: C.green }}>«Celimax»</strong> и <strong style={{ color: C.green }}>«CELIMAX»</strong> — так, как название указано в карточке товара.</div>
              </div>
            </div>

            <div style={{ ...sCard, padding: "16px 0" }}>
              <div style={{ fontSize: 13, fontWeight: 400, color: C.amber, marginBottom: 8 }}>Причина #2: Бренд записан иначе, чем вы ищете</div>
              <div style={{ fontSize: 13, color: "var(--personal-text)", lineHeight: 1.8 }}>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>Пошаговая инструкция: как перепроверить бренд</h3>

            <div style={{ ...sCard, padding: "20px 24px" }}>
              <div style={{ fontSize: 14, lineHeight: 2.2, color: "var(--personal-text)" }}>
                <div><span style={{ color: C.accent, fontWeight: 400 }}>Шаг 1.</span> Откройте на Kaspi категорию, к которой относится товар.</div>
                <div><span style={{ color: C.accent, fontWeight: 400 }}>Шаг 2.</span> <strong style={{ color: C.text }}>Начните с категории</strong>, а не с бренда: «Красота и здоровье» → «Уход за лицом» → «Кремы и сыворотки».</div>
                <div><span style={{ color: C.accent, fontWeight: 400 }}>Шаг 3.</span> Внутри категории — отсортируйте по выручке (от большего к меньшему). Вы увидите топ-бренды.</div>
                <div><span style={{ color: C.accent, fontWeight: 400 }}>Шаг 4.</span> Для поиска конкретного бренда — вбивайте <strong style={{ color: C.text }}>точное название с правильным регистром</strong>:</div>
                ...
                <div><span style={{ color: C.accent, fontWeight: 400 }}>Шаг 5.</span> Если бренд не находится — попробуйте <strong style={{ color: C.text }}>поиск по товару</strong>: вбейте название продукта (например, «Dual Barrier Toner» или «345 Relief»).</div>
                <div><span style={{ color: C.accent, fontWeight: 400 }}>Шаг 6.</span> Для сравнения используйте один и тот же полный месяц и обязательно фиксируйте дату проверки.</div>
              </div>
            </div>

            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>Шпаргалка: как искать бренды из вашего портфеля</h3>
        ...
        <div style={{ marginBottom: 56 }}>
          ...
          <div style={{ ...sCard }}>
            ...
            <div style={{ ...sCard, padding: "16px 0", marginBottom: 16 }}>
              <div style={{ fontSize: 12, color: C.blue, fontWeight: 400, marginBottom: 4 }}>Период данных и важная особенность</div>
              <div style={{ fontSize: 13, color: "var(--personal-text)", lineHeight: 1.6 }}>Выручка = <strong style={{ color: C.text }}>февраль 2026</strong>. На Kaspi <strong style={{ color: C.text }}>нет отдельной категории «SPF / Солнцезащита»</strong> — SPF-кремы размещены внутри «Кремы и сыворотки», «Тональные средства» и «Основы и фиксаторы». Мы собрали все SPF-продукты вручную через поиск по ключевым словам (SPF, солнцезащитный, sun). Февраль — начало сезона, пик будет в мае-июле.</div>
            </div>

            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "20px 0 16px" }}>Топ-15 SPF-продуктов для лица на Kaspi (февраль 2026)</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>SPF-продукты из вашего портфеля (21 бренд)</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>Ценовые сегменты SPF-кремов</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>Конкуренты вне портфеля</h3>
        ...
        <div style={{ marginBottom: 56 }}>
          ...
          <div style={{ ...sCard }}>
            ...
            <div style={{ ...sCard, padding: "16px 0", marginBottom: 16 }}>
              <div style={{ fontSize: 12, color: C.blue, fontWeight: 400, marginBottom: 4 }}>Период и метод</div>
              <div style={{ fontSize: 13, color: "var(--personal-text)", lineHeight: 1.6 }}>
                <strong style={{ color: C.text }}>Wildberries:</strong> данные за год (апрель 2025 — март 2026) из агрегированные данные Wildberries. Выручка и продажи по 21 бренду портфеля — 3 364 уникальных продавца идентифицированы.<br/>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "20px 0 16px" }}>Wildberries — Топ-20 продавцов beauty-портфеля (год, апр 2025 — мар 2026)</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>Kaspi — Крупнейшие продавцы beauty</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>Количество продавцов по категориям beauty на Kaspi (февраль 2026)</h3>
        ...
        <div style={{ marginBottom: 56 }}>
          <div style={{ ...sCard }}>
            ...
            <p style={{ fontSize: 15, fontWeight: 400, color: C.text, margin: "0 0 12px", lineHeight: 1.7 }}>
          ...
          <div style={{ ...sCard }}>
            ...
            <div style={{ ...sCard, padding: "16px 0", marginBottom: 20 }}>
              <div style={{ fontSize: 12, color: C.red, fontWeight: 400, marginBottom: 8, textTransform: "none", letterSpacing: "0.05em" }}>Главный вывод с первой строки</div>
            ...
            <h3 style={{ fontSize: 18, fontWeight: 400, color: C.accent, margin: "28px 0 16px", borderTop: `1px solid ${C.border}`, paddingTop: 24 }}>1. Mizon на Kaspi — полный факт-чек</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>Весь каталог Mizon на Kaspi (февраль 2026)</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>Mizon SPF — точные SKU и цены (февраль 2026)</h3>
            ...
            <h3 style={{ fontSize: 18, fontWeight: 400, color: C.accent, margin: "40px 0 16px", borderTop: `1px solid ${C.border}`, paddingTop: 24 }}>2. Полная карта цен SPF на Kaspi — «подделки vs оригиналы»</h3>
            ...
            <div style={{ paddingLeft: 14, margin: "20px 0", fontSize: 14, color: "var(--personal-text)", lineHeight: 1.7 }}>
            ...
            <h3 style={{ fontSize: 18, fontWeight: 400, color: C.accent, margin: "40px 0 16px", borderTop: `1px solid ${C.border}`, paddingTop: 24 }}>3. Прошлый год vs этот год — Round Lab парадокс</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>Round Lab в «Кремы и сыворотки» — 16 месяцев</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>Сравнение YoY: Round Lab vs остальные K-beauty бренды в той же категории</h3>
            ...
            <h3 style={{ fontSize: 18, fontWeight: 400, color: C.accent, margin: "40px 0 16px", borderTop: `1px solid ${C.border}`, paddingTop: 24 }}>4. Вскрытие топ-SPF: кто на самом деле продаёт Round Lab Birch Juice SPF</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>Распределение 132 продавцов по цене</h3>
            ...
            <h3 style={{ fontSize: 18, fontWeight: 400, color: C.accent, margin: "40px 0 16px", borderTop: `1px solid ${C.border}`, paddingTop: 24 }}>5. AI-анализ отзывов Round Lab Birch SPF — доказательство «серого тумана»</h3>
            ...
            <div style={{ ...sCard }}>
              <div style={{ display: "flex", gap: 16, marginBottom: 12, flexWrap: "wrap" }}>
                <div><div style={{ fontSize: 11, color: C.dim }}>Всего отзывов</div><div style={{ fontSize: 16, fontWeight: 400, color: C.text }}>3 816</div></div>
                <div><div style={{ fontSize: 11, color: C.dim }}>Негативных</div><div style={{ fontSize: 16, fontWeight: 400, color: C.red }}>260 (6.8%)</div></div>
                <div><div style={{ fontSize: 11, color: C.dim }}>Реальный средний рейтинг</div><div style={{ fontSize: 16, fontWeight: 400, color: C.red }}>2.07 </div></div>
                <div><div style={{ fontSize: 11, color: C.dim }}>Показывает Kaspi</div><div style={{ fontSize: 16, fontWeight: 400, color: C.text }}>4.8 </div></div>
              </div>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>Топ-10 негативных отзывов о подделках (ранжировано по лайкам)</h3>
            ...
            <div style={sCard}>
              {[
                ...
                <div key={i} style={{ paddingLeft: 12, margin: "10px 0", fontSize: 12, color: "var(--personal-muted)", lineHeight: 1.55 }}>
                  <div style={{ fontSize: 11, color: C.dim, marginBottom: 2 }}>
                    <span style={{ color: C.red, fontWeight: 400 }}>★ {r.stars}</span> ·  {r.likes} · <strong style={{ color: C.amber }}>{r.merchant}</strong>
                  </div>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 400, color: C.accent, margin: "28px 0 16px" }}>AI-анализ отзывов — ключевые паттерны</h3>

            <div style={sCard}>
              <p style={{ fontSize: 13, color: "var(--personal-text)", lineHeight: 1.7, margin: "0 0 12px" }}>
              ...
              <p style={{ fontSize: 13, color: "var(--personal-text)", lineHeight: 1.7, margin: 0 }}>
            ...
            <h3 style={{ fontSize: 18, fontWeight: 400, color: C.accent, margin: "40px 0 16px", borderTop: `1px solid ${C.border}`, paddingTop: 24 }}>6. Прямой ответ на ваши три гипотезы</h3>

            <div style={{ ...sCard }}>
              <h3 style={{ fontSize: 15, fontWeight: 400, color: C.green, margin: "0 0 10px" }}>Гипотеза 1: «В прошлом году Mizon был в топ-5, в этом году не в топ-10»</h3>
              <p style={{ fontSize: 13, color: "var(--personal-text)", lineHeight: 1.7, margin: 0 }}>
            ...
            <div style={{ ...sCard }}>
              <h3 style={{ fontSize: 15, fontWeight: 400, color: C.green, margin: "0 0 10px" }}>Гипотеза 2: «Общие продажи Mizon №2, но всё ушло в офлайн, не онлайн»</h3>
              <p style={{ fontSize: 13, color: "var(--personal-text)", lineHeight: 1.7, margin: 0 }}>
            ...
            <div style={{ ...sCard }}>
              <h3 style={{ fontSize: 15, fontWeight: 400, color: C.green, margin: "0 0 10px" }}>Гипотеза 3: «Из-за подделок многие бренды ушли в лидеры только из-за цены. У Mizon нет подделок — и именно из-за ценового сегмента он ушёл вниз, не количественно, а из-за цены»</h3>
              <p style={{ fontSize: 13, color: "var(--personal-text)", lineHeight: 1.7, margin: 0 }}>
              ...
              <div style={{ fontSize: 13, color: "var(--personal-text)", lineHeight: 1.9, marginTop: 12 }}>
            ...
            <div style={{ ...sCard }}>
              <h3 style={{ fontSize: 15, fontWeight: 400, color: C.amber, margin: "0 0 10px" }}>Гипотеза 4 (бонус): «На WB выбирают по галочке "официальный дистрибьютор", на Kaspi — только по цене»</h3>
              <p style={{ fontSize: 13, color: "var(--personal-text)", lineHeight: 1.7, margin: 0 }}>
            ...
            <h3 style={{ fontSize: 18, fontWeight: 400, color: C.accent, margin: "40px 0 16px", borderTop: `1px solid ${C.border}`, paddingTop: 24 }}>7. Что из этого следует для вашей стратегии</h3>

            <div style={sCard}>
              <div style={{ fontSize: 13, lineHeight: 2.0, color: "var(--personal-text)" }}>
                <div style={{ marginBottom: 10 }}>
                  <span style={{ color: C.accent, fontWeight: 400, marginRight: 8 }}>1.</span>
                ...
                <div style={{ marginBottom: 10 }}>
                  <span style={{ color: C.accent, fontWeight: 400, marginRight: 8 }}>2.</span>
                ...
                <div style={{ marginBottom: 10 }}>
                  <span style={{ color: C.accent, fontWeight: 400, marginRight: 8 }}>3.</span>
                ...
                <div style={{ marginBottom: 10 }}>
                  <span style={{ color: C.accent, fontWeight: 400, marginRight: 8 }}>4.</span>
                ...
                <div style={{ marginBottom: 10 }}>
                  <span style={{ color: C.accent, fontWeight: 400, marginRight: 8 }}>5.</span>
                ...
                <div style={{ marginBottom: 10 }}>
                  <span style={{ color: C.accent, fontWeight: 400, marginRight: 8 }}>6.</span>
            ...
            <div style={{ paddingLeft: 14, margin: "24px 0", fontSize: 14, color: "var(--personal-text)", lineHeight: 1.7 }}>
              <strong style={{ color: C.green }}>Короткий ответ: </strong>
