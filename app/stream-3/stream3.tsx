    ...
    <div className={`s3 ${theme}`}>
      ...
      <div className="s3-wrap">
        ...
        <p className="s3-lead dim">
          ...
          ответ. По своим данным. Человеческим языком. Каждый день, без вас.
        </p>
        ...
        <div className="s3-sec">
          ...
          <p>
            Kaspi и Redstat — освоились в привычной среде. Wildberries и MPStats
            API — научились автоматизировать рутину. Amazon — научились видеть
            будущее. База знаний — всё предыдущее сложилось в систему, которая
            работает без вас каждый день.
          </p>
        </div>
