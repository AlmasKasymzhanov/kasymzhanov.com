...
export const metadata: Metadata = personalMetadata("Карманный аналитик Kaspi — материалы форума | Алмас Касымжанов", "Разбор концепта, пошаговое объяснение установки и архив MCP-коннектора. Своя аналитика Kaspi-магазина через Claude — без дашборда и без кода.", "/sellers-forum");
        ...
        {ITEMS.map((it) => (
          ...
          >
            ...
            <div className="ka-body">
              <h2>{it.title}</h2>
              <p>{it.desc}</p>
              <span className="ka-go">{it.go}<IconlyArrowUpRight /></span>
            </div>
          </a>
        ))}
